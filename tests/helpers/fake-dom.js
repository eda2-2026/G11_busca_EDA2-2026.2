...
export function createFakeSimulatorDocument({ minimum = "500", maximum = "2000" } = {}) {
  const elements = new Map([
    ...
    ["#run-binary", new FakeElement({ disabled: true })],
    ...
    ["#binary-search-log", new FakeElement()],
    ["#algorithm-comparison", new FakeElement()],
    ["#linear-attempts", new FakeElement()],
    ["#binary-attempts", new FakeElement()],
    ["#comparison-winner", new FakeElement()],
    ["#comparison-difference", new FakeElement()],
